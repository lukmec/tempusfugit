...
import de.lumdev.tempusfugit.fragments.OverviewArchivedGroupEventFragmentDirections;
...
public class OverviewArchivedGroupEventFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recycler_archived_groupEvents);
        GroupEventAdapter adapter = new GroupEventAdapter(getActivity());

        viewModel.getGroupEventsByArchiveState(true).observe(getViewLifecycleOwner(), adapter::submitList);
